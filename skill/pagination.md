...
| Outer radius | `radius-md` (2px) on first/last segment outer corners |
...
A horizontal flex: summary text at the inline start ("Showing **1–10** of **1000**"), pagination at the inline end. The summary is `font-size-sm`, `body`; emphasized numbers are `font-weight-medium`, `heading`.
